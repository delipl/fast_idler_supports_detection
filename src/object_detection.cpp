...
void ObjectDetection::declare_parameters() {
    ...
    declare_parameter("outlier_remover.radius_outlier.neightbours_count", "8");
    ...
    declare_parameter("clusteler.euclidean.min_size", "1000");
    declare_parameter("clusteler.euclidean.max_size", "5000");
}
...
void ObjectDetection::get_parameters() {
    ...
    outlier_remover.statistical_neightbours_count =
        std::stoi(get_parameter("outlier_remover.statistical.neightbours_count").as_string());
    ...
    outlier_remover.radius_outlier_neightbours_count =
        std::stoi(get_parameter("outlier_remover.radius_outlier.neightbours_count").as_string());
...
void ObjectDetection::lidar_callback(const rclcppCloudSharedPtr msg) {
    ...
    auto clustered_clouds = clusteler.euclidean(ground_removed);
