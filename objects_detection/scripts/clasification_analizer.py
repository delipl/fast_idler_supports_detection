...
for frame in data:
    ...
    normalization_durations = np.append(
        normalization_durations, float(frame["durations"]["normalization"])
    )
    density_segmentation_durations = np.append(
        density_segmentation_durations, float(frame["durations"]["density_segmentation"])
    )
    supports_clusterization_durations = np.append(
        supports_clusterization_durations, float(frame["durations"]["supports_clusterization"])
    )
    supports_classification_durations = np.append(
        supports_classification_durations, float(frame["durations"]["supports_classification"])
    )
...
after_density_segmentation_durations = after_normalization_times + density_segmentation_durations
...
table = plt.table(cellText=table_data, loc="upper right", cellLoc="center", colLabels=None)
